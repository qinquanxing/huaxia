...
function checklogin(){
	...
	#打开一个窗口
		if($url == ""){$this->ErrorMsg("base.class.php中WindwoOpen函数的\$url参数不能为空！");exit();}
		echo "<script type=\"text/Javascript\">\n";
	...
	#提示后打开指定某网页
		if($url == "" or $msg == ""){$this->ErrorMsg("base.class.php中WarnUrl函数的\$url或\$msg参数不能为空！");exit();}
		echo "<script type=\"text/Javascript\">\n";
		echo "	alert(\"".$msg."\");\n";
	...
	#提示信息，确认后打开指定网页
		if($url == "" or $msg == ""){$this->ErrorMsg("base.class.php中ConfirmUrl函数的\$url或\$msg参数不能为空！");exit();}
		echo "<script type=\"text/Javascript\">\n";
		echo "	if(confirm(\"".$msg."\")){\n";
		echo "		location.href=\"".$url."\";\n";
		echo "	}else{\n";
	...
	function Warn($msg){
		if($msg == ""){$this->ErrorMsg("base.class.php中Warn函数的\$msg参数不能为空！");exit();}
		echo "<script type=\"text/Javascript\">\n";
		echo "	alert(\"".$msg."\");\n";
		echo "	return false;\n";
		echo "</script>\n";
	...
	function Url($url){
		if($url == ""){$this->ErrorMsg("base.class.php中Url函数的\$url参数不能为空！");exit();}
		echo "<script type=\"text/Javascript\">\n";
		echo "	location.href=\"".$url."\";\n";
		echo "</script>\n";
	}
