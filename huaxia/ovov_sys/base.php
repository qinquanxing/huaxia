...
$smarty = new Smarty;
require_once(INCLUDE_CLASSPATH."/Ad.class.php");
$ad = new Ad();
require_once(INCLUDE_CLASSPATH."/str.class.php");
$str = new str();
require_once(INCLUDE_CLASSPATH."/page.class.php");
$page= new page();
require_once(INCLUDE_CLASSPATH."/image.class.php");
$pic = new image();
