<?php /* Smarty version 2.6.14, created on 2015-12-16 19:47:33
         compiled from position/manage_edit.html */ ?>
...
" name="add_form" id="form_submit" method="post" enctype="multipart/form-data">
		<input type="hidden" name="id" value="<?php echo $this->_tpl_vars['con']['id']; ?>
"/>		
		<table width="100%" border="0" cellspacing="1" cellpadding="0" style="background:#d5dde0;" class="table_font">
			<tr style="background:url(common/skin/1/images/table_title.gif) repeat-x;">
				...
				<td align="left" bgcolor="#FFFFFF">&nbsp;
					<input class="s_sear" type='text' name="phone" id="phone" value="<?php echo $this->_tpl_vars['con']['phone']; ?>
"/>&nbsp;&nbsp;<span class="a1"></span>
				</td>
			</tr>			
			<tr style="background:url(common/skin/1/images/table_title.gif) repeat-x;">
				...
				<td align="left" bgcolor="#FFFFFF">&nbsp;
					<input class="s_sear" type='text' name="email" id="email" value="<?php echo $this->_tpl_vars['con']['email']; ?>
"/>&nbsp;&nbsp;<span class="a2"></span>
				</td>
			</tr>
			<tr style="background:url(common/skin/1/images/table_title.gif) repeat-x;">
				...
				<td align="left" bgcolor="#FFFFFF">&nbsp;
					<div style="width:180px;padding-left:10px;float:left"><input class="s_sear" type=text name="scode" id="scode" value="<?php echo $this->_tpl_vars['con']['sms_code']; ?>
"/>		</div>
			...
			<tr style="background:url(common/skin/1/images/table_title.gif) repeat-x;">
				...
				<td align="left" bgcolor="#FFFFFF">&nbsp;
					<div style="width:180px;padding-left:10px;float:left"><input class="s_sear" type=text name="icode" id="icode" value="<?php echo $this->_tpl_vars['con']['invest_code']; ?>
"/>		</div>
			...
			<tr style="background:url(common/skin/1/images/table_title.gif) repeat-x;">
				...
				个人:<input type="radio"   name="reg_type" <?php if ($this->_tpl_vars['con']['reg_type'] == 1): ?> checked="checked"<?php else: ?> " " <?php endif; ?> value="1">&nbsp;&nbsp;	
			
				公司:<input type="radio" <?php if ($this->_tpl_vars['con']['reg_type'] == 2): ?> checked="checked"<?php else: ?> " " <?php endif; ?> name="reg_type" value="2">
			...
			<tr style="background:url(common/skin/1/images/table_title.gif) repeat-x;">
				...
				<td align="left" bgcolor="#FFFFFF">&nbsp;
					启用:<input type="radio"  <?php if ($this->_tpl_vars['con']['state'] == 1): ?> checked="checked"<?php else: ?> " " <?php endif; ?> name="state" value="1">&nbsp;&nbsp;		
					禁用:<input type="radio" name="state" <?php if ($this->_tpl_vars['con']['state'] == 2): ?> checked="checked"<?php else: ?> " " <?php endif; ?>  value="2">
				</td>
			</tr>
			<tr style="background:url(common/skin/1/images/table_title.gif) repeat-x;">
