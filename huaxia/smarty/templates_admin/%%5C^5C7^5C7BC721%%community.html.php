<?php /* Smarty version 2.6.14, created on 2015-11-10 18:58:06
         compiled from position/community.html */ ?>
...
<div class="main">
	...
	<a class="s" onclick="ajax_chanel('position.php?action=community_add','新建','800px','320px')" href="javascript:void(0);">
...
<?php if ($this->_tpl_vars['res']['is_show'] == 1): ?>
					<a class="cz_btn" href="javascript:void(0);" onclick="ovajax_confirm('position.php','action=community_show&id=<?php echo $this->_tpl_vars['res']['id']; ?>
','确认取消显示')">取消显示</a>
<?php else: ?>
					<a class="cz_btn" href="javascript:void(0);" onclick="ovajax_confirm('position.php','action=community_show&id=<?php echo $this->_tpl_vars['res']['id']; ?>
&up=1','确认显示')">显示</a>
<?php endif; ?>	
					<a class="cz_btn" href="javascript:void(0);" onclick="ajax_chanel('position.php?action=community_edit&id=<?php echo $this->_tpl_vars['res']['id']; ?>
','修改','800px','320px')">修改</a>
					<a class="cz_btn" href="javascript:void(0);" onclick="ovajax_confirm('position.php','action=community_del&id=<?php echo $this->_tpl_vars['res']['id']; ?>
&up=1','确认删除')">删除</a>
				</td>
            </tr>
<?php endforeach; endif; unset($_from); ?>
			<tr height="32" bgcolor="#FFFFFF" align="center" onmouseout="listBgOut(this);" onmouseover="listBgOver(this);">
				...
				<input id="delall" class="button" type="button" value=" 删 除 选 中 " onclick="ov_delall('iform','position.php?action=community_delAll','gid=','确定要删除选中',0,2);"/>
				</td>
			</tr>
