<?php /* Smarty version 2.6.14, created on 2015-11-10 11:28:15
         compiled from ovoa/ovoa_quanxian_quanxian.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'in_array', 'ovoa/ovoa_quanxian_quanxian.html', 80, false),)), $this); ?>
...
function setAll(id,N){
	...
	if(string == ""){
		...
		if(confirm('确认设置这些权限？')){
		location.href="ovoa.php?action=Do_Ovoa_Quanxian_DIY&qxid="+id+"&list_id="+string;
		}
	}
}
...
<body>
<div class="main">
  <div class="main_title"><strong>自定义权限</strong><span></span>
    <p></p>
  </div>
  <!--自定义权限b-->
  <div class="contents" style="display:block">
    <div>
	<input type="hidden" id="diyqx_id" value="<?php echo $this->_tpl_vars['diyqx_id']; ?>
" />
...
">	
			...
			<td align="left" width="10%">&nbsp;<input type="checkbox" name="cid<?php echo $this->_sections['dalei']['index']; ?>
...
" <?php if (((is_array($_tmp=$this->_tpl_vars['channelxiao'][$this->_sections['xiaolei']['index']]['channel_id'])) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['user_sview']) : in_array($_tmp, $this->_tpl_vars['user_sview']))): ?> checked="checked"<?php endif; ?> />&nbsp;<?php echo $this->_tpl_vars['channelxiao'][$this->_sections['xiaolei']['index']]['channel_name']; ?>
			...
			<td align="left" width="90%" colspan="2">&nbsp;<INPUT class="but_modfy" type=submit value=" " name="submit" id="submit"  onClick="setAll(<?php echo $this->_tpl_vars['diyqx_id']; ?>
