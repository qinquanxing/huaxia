<?php /* Smarty version 2.6.14, created on 2015-11-10 19:10:36
         compiled from position/community_add.html */ ?>
...
<?php endforeach; endif; unset($_from); ?>
			...
			<tr style="background:url(common/skin/1/images/table_title.gif) repeat-x;">
				<td height=32 align="right" width="100">小区名称&nbsp;</td>
				<td align="left" bgcolor="#FFFFFF">&nbsp;
					<input class="u_input320" type=text name="data[name]" id="name" value="" />
				</td>
			</tr>
			<tr style="background:url(common/skin/1/images/table_title.gif) repeat-x;">
				<td height=32 align="right" width="100">定位&nbsp;</td>
				<td align="left" bgcolor="#FFFFFF">&nbsp;
